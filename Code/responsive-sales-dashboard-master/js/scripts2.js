...
function onMessageArrived(message) {
  ...
  $(document).ready(function () {
    $.post("adddata2.php", $("#form2_data").serialize(), function () {});
  });
  // vẽ point trên map
  var latlngs = [
    [lat_af, lng_af],
...
function processDisconnectedData() {
  console.log("Xử lý dữ liệu sau khi mất kết nối");
  $.post("readdataa2.php", function (data) {
    ...
    document.getElementById("Kp").innerHTML = totalDistance;
    document.getElementById("Ki").innerHTML = maxSpeed;
    document.getElementById("Kd").innerHTML = averageHR;
    document.getElementById("Ke").innerHTML = (time / 300000).toFixed(3);
    ////////////////////////////////////////////////////////////////////////////////
    ...
    map.setView([10.85082, 106.77328], 19);
    var heat = L.heatLayer(latLongArray, {
      radius: 7,
      gradient: {
        0: "blue",
        0: "lime",
